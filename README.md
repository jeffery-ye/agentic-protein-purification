"Automated extraction and optimization of protein purification protocols using multi-agent large language models" available to read here: [link coming soon]. This application was developed at Seattle Children’s Research Institute (SCRI) which is part of Seattle Children’s Hospital (SCH) by Jeffery Ye
